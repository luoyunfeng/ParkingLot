...
public class parkPlaceTest {
    ...
    public void parkBoy_ShouldParkCar(){
        ...
        ParkingBoy parkinfBoy = new ParkingBoy(parkPlace);
        Ticket ticket = parkinfBoy.parking(car);
        Assert.assertEquals(new Integer(maxParkingNum - 1), parkPlace.GetAvailableNum());
