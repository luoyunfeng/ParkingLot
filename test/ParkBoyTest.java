...
public class ParkBoyTest {
    private ParkingBoy parkBoyNormal;
    private ParkingBoy parkBoySmart;
    private ParkingBoy parkBoySuper;
    ...
    public void initParkBoy(){
        ...
        parkBoyNormal = new ParkingBoy(new NormalChooser(), parkBoyNormalLots, "PB.001");
        ...
        parkBoySmart = new ParkingBoy(new SmartChooser(), parkBoySmartLots, "PB.002");
        ...
        parkBoySuper = new ParkingBoy(new SuperChooser(), parkBoySuperLots, "PB.003");
    }
